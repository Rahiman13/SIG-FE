...
const EmployeesPage = () => {
    ...
    const filteredEmployees = employees.filter(employee => {
        ...
        const employeeStatus = employee.status || 'Active'; // Default to 'Active' if status is null
        const matchesStatus =
            currentTab === 0 || // All employees
            (currentTab === 1 && employeeStatus === 'Active') || // Active employees
            (currentTab === 2 && employeeStatus !== 'Active'); // Inactive employees
    ...
    // Modify the menu items to include edit option
    const renderMenu = () => (
        <Menu
            anchorEl={anchorEl}
        ...
        >
            <MenuItem onClick={() => {
                handleViewDetails(selectedEmployee);
                handleMenuClose();
            }}>
                <ListItemIcon>
    ...
    if (loading) {
        return (
            <Box sx={{
                ...
                <LoadingOverlay open={loading || submitting}>
                    <Box sx={{ textAlign: 'center' }}>
                        <CircularProgress size={60} thickness={4} />
                        <Typography variant="h6" sx={{ mt: 2, color: 'text.primary' }}>
                            {submitting ? 'Updating...' : 'Loading...'}
                        </Typography>
                    </Box>
                </LoadingOverlay>
                ...
                >
                    <Box sx={{
                        ...
                        <Container maxWidth="xl">
                            ...
                            {/* Add EditModal to the return statement */}
                            <EditModal />
                        </Container>
